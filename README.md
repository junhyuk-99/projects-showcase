...
회사 정책 및 보안상의 이유로 소스 코드는 포함하지 않으며, **시스템 구조와 설계, 문제 해결 과정** 위주로 작성했습니다.
...
| 프로젝트 | 설명 | 링크 |
|---------|------|------|
| **Real-time Data Tracking & Monitoring System** | 실시간 데이터 자동 집계·정합 및 상태 모니터링 시스템 | [/data-tracking](./data-tracking) |
| **CNC/MCT Analytics Dashboard** | MongoDB 기반 데이터 수집·분석 대시보드 (단독 개발, 저작권 등록) | [/dashboard](./dashboard) |
