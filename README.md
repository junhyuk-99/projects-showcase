...
각 프로젝트 폴더에는 시스템 구조, 설계 과정, 주요 문제 해결 사례를 정리했습니다.
...
| 프로젝트 | 설명 | 링크 |
|---------|------|------|
| Real-time Data Tracking & Monitoring | 실시간 데이터 자동 집계·정합 및 상태 모니터링 시스템 | [/nwm](./nwm) |
| CNC/MCT Analytics Server | MongoDB 기반 데이터 수집·분석 대시보드 (단독 개발, 저작권 등록) | [/dashboard](./dashboard) |
