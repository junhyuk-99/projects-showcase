...
MongoDB 기반 실시간 운영 데이터 수집·모니터링·분석 대시보드
Spring Boot + React 기반 실시간 운영 데이터 모니터링 및 분석 플랫폼
...
현재 회사 솔루션 형태로 활용되고 있으며, **한국저작권위원회 프로그램 저작권 등록 완료** 된 소프트웨어입니다.
타 프로젝트 납품 시 본 솔루션을 포함하여 제공하는 형태로 사업화를 진행하고 있습니다.

> 본 문서와 화면은 실무 프로젝트 기반이며,
> 보안 정책에 따라 일부 정보는 생략되거나 수정되었습니다.
...
- 실시간 운영 데이터 수집 및 상태 모니터링
- MongoDB 기반 유연한 데이터 구조 설계
- Spring Boot API 기반 데이터 집계 및 조회
- React 기반 운영 대시보드 UI
...
```
Data Source (External Systems / Sensors)
      ↓
   MongoDB
      ↓
Spring Boot API Server (MongoDB 연동 / API)
      ↓
 React Web Client
```
...
- **고객사 환경에 배포 후 운영 중**
- **한국저작권위원회 프로그램 저작권 등록 완료 (2026.03)**
- 회사 솔루션으로 활용 중, 타 프로젝트 납품 시 솔루션으로 제공 예정
